...
export function ContadorCliques({ cliques, setCliques }) {
  return (
    <div style={{ padding: '15px', border: '1px solid #646cff', marginTop: '10px', borderRadius: '8px' }}>
...
export default function App() {
  ...
  const recursosReact = ['Vite', 'Function Components', 'Named Exports', 'useState', 'useEffect', 'Props'];
