...
const styles = {
  ...
  card: { border: '1px solid #38c700f1', borderRadius: '8px', padding: '15px', marginBottom: '20px', backgroundColor: '#6b6b6b' },
...
const Quiz = () => {
  ...
  return (
    <section style={{ ...styles.card, backgroundColor: '#ffffff' }}>
      ...
      <button onClick={() => setRespondido(!respondido)} style={styles.button}>
        {respondido ? 'Ocultar Resposta ' : 'Mostrar Resposta'}
      </button>
      {respondido && (
